...
const { applyBundlePricing } = require("../services/bundle.service");
...
const createCodOrder = async (req, res) => {
  try {
    ...
    const discountedCartItems = discountedLineItems.map((li) => ({
...
module.exports.createCodOrder = createCodOrder;
